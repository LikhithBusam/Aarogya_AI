...
#         "rating": 4.9,
#         "email": "likhith.b.polavaram@gmail.com",
...
#             if sender_email == "likhith.b.polavaram@gmail.com" and sender_password == "ohzc idub grps czwb":
...
if __name__ == "__main__":
    ...
    # The debug=True mode is for development only
    app.run(debug=True, port=5000)